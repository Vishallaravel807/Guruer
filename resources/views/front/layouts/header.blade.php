    ...
    <div class="container center-row">
      <div class="row py-3 border-bottom">
        ...
        <div class="col-sm-4 col-lg-3 text-center mob--left text-sm-start">
          <div class="main-logo">
            <a href="{{ url('/') }}">
              <img src="{{ url('/public') }}/front_assets/images/guruer.jpg" alt="logo"  width="50%"  height="10%">
            </a>
          </div>
        </div>
              ...
              <div class="offcanvas-body">
                ...
                <ul class="navbar-nav justify-content-end desk-hide menu-list list-unstyled d-flex gap-md-3 mb-0">
                  <li class="nav-item active">
                    <a href="{{ url('/') }}" class="nav-link">Home <i class="bi bi-chevron-down"></i></a>
                  </li>
                ...
                <ul class="d-flex list-unstyled m-2">
                  ...
                  <li>
                    ...
                    <i class='fas fa-user-circle' style="color: green;"><span style="color: black;">{{ Auth::guard('user')->user()->first_name }}</span></i>
                    </a>
                  </li>
                  @endif  
                  <li class="d-lg-none">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              ...
              <div class="offcanvas-body">
                ...
                <ul class="navbar-nav justify-content-end  menu-list list-unstyled d-flex gap-md-3 mb-0">
                  ...
                  <li class="nav-item dropdown">
                    <a href="{{ url('/AllGuruer') }}" class="nav-link">All Guruer</a>
                  </li>
                </ul>
